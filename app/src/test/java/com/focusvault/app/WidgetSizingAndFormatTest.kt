...
import com.focusvault.app.appwidget.FocusWidgetProvider
import com.focusvault.app.appwidget.WidgetDataProvider
import com.focusvault.app.appwidget.WidgetSizeTier
...
class WidgetSizingAndFormatTest {
    ...
    fun testBoundaryAndEdgeCases() {
        ...
        // With the recent fix for clipping, if minHeight <= 110, it safely snaps to WIDE (or TINY) instead of COMPACT
        assertEquals(WidgetSizeTier.WIDE, resolveSizeTier(150, 105))
        assertEquals(WidgetSizeTier.WIDE, resolveSizeTier(219, 110))
    }
